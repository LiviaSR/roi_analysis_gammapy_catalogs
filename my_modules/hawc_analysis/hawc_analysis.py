...
def get_dict():
    ...
    return {
    "2HWC J1825-134": {
        "position":  SkyCoord(276.46,-13.40, unit="deg"), # 2HWC catalogue       
    }, 
    "HAWC J1825-138": {
        "position":  SkyCoord(276.38,-13.86, unit="deg"), # https://arxiv.org/pdf/2012.15275.pdf
    },
    "HAWC J1826-128": {
        "position":  SkyCoord(276.50,-12.86, unit="deg") # https://arxiv.org/pdf/2012.15275.pdf
    },
    "HAWC J1825-134": {
        "position":  SkyCoord(276.44,-13.42, unit="deg") # https://arxiv.org/pdf/2012.15275.pdf
    },
    "eHWC J1825-134": {
        "position":  SkyCoord(276.40,-13.37, unit="deg") # https://arxiv.org/pdf/1909.08609.pdf
    },
    "eHWC J1907+063": {
        "position":  SkyCoord(286.91,6.32, unit="deg") # https://arxiv.org/pdf/1909.08609.pdf
    }, 
    "eHWC J2019+368": {
        "position":  SkyCoord(304.95,36.78, unit="deg") # https://arxiv.org/pdf/1909.08609.pdf
    }, 
}
...
def get_HAWC_tables_datasets(dict_HAWC):
    ...
    for source_index, source_name in enumerate(list(dict_HAWC.keys())):
        ...
        table = table_to_SED_format(cfg.path_fp_HAWC, utl.utl.name_to_txt(source_name))
        tables.append(table)
